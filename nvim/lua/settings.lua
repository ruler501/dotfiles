...
wk.register({
  ...
  ['g'] = {
      ...
      ['t'] = {
          ['d'] = { vim.lsp.buf.type_definition, "Go to the type definition of the symbol under the cursor.", mode = 'n'},
      },
  },
  ...
  ['q'] = { '<Nop>', '', mode = 'n' },
  ['<C-R>'] = {
      ['h'] = { '<Cmd>call animate#window_delta_height(5)<CR>', "Smoothly increase the current windows height by 5 rows.", mode = 'n' },
      ['H'] = { '<Cmd>call animate#window_delta_height(-5)<CR>', "Smoothly decrease the current windows height by 5 rows.", mode = 'n' },
      ['w'] = { '<Cmd>call animate#window_delta_width(5)<CR>', "Smoothly increase the current windows width by 5 columns.", mode = 'n' },
      ['W'] = { '<Cmd>call animate#window_delta_width(-5)<CR>', "Smoothly decrease the current windows height by 5 columns.", mode = 'n' },
  },
  ['s'] = {
      ['c'] = {
      ...
      ['r'] = { '<Cmd>TroubleToggle lsp_references<CR>', "Toggle showing all references to the symbol under the cursor.", mode = 'n' },
  },
  ['t'] = {
      ['d'] = {
        ['d'] = { '<Cmd>TroubleToggle document_diagnostics<CR>', "Toggle showing a window with the diagnostics for the current document.", mode = 'n' },
        ['w'] = { '<Cmd>TroubleToggle workspace_diagnostics<CR>', "Toggle showing a window with all the diagnostics for the current workspace.", mode = 'n' },
      },
      ['l'] = {
        ['l'] = { '<Cmd>TroubleToggle loclist<CR>', "Toggle showing a window with the location list.", mode = 'n' },
      },
      ['q'] = { '<Cmd>TroubleToggle quickfix<CR>', "Toggle showing a window with the current quickfix list.", mode = 'n' },
      ['r'] = { '<Cmd>TroubleToggle lsp_references<CR>', "Toggle showing all references to the symbol under the cursor.", mode = 'n' },
      ['s'] = { '<Cmd>SymbolsOutline<CR>', 'Toggle showing a tree based outline of all symbols in the current buffer.', mode = 'n' },
